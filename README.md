...
Мой вариант тренировки рефакторинга и тестирования Gilded Rose Refactoring Kata. Исходил из того что могут добавиться новые товары или магазины с новым ассортиментом. А так же, что название товара может просто включать ключевые слова, а не быть точь в точь.
